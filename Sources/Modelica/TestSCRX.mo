package TestSCRX
  ...
  package Experiments
    ...
    model TestWithOpenIPSLInitAsInput
      extends OpenIPSL.Tests.BaseClasses.SMIB(pwFault(t1=12, t2=12.15));
    OpenIPSL.Electrical.Machines.PSSE.GENROU gENROU(D = 0, H = 4.28,
        M_b=100000000,
        P_0=40000000,
        Q_0=5416582,                                                                                                 R_a = 0, S10 = 0.11, S12 = 0.39, Tpd0 = 5, Tppd0 = 0.07, Tppq0 = 0.09, Tpq0 = 0.9, Xd = 1.84, Xl = 0.12, Xpd = 0.41, Xpp = 0.2, Xppd = 0.2, Xppq = 0.2, Xpq = 0.6, Xq = 1.75,
      ...
      Modelica.Blocks.Sources.RealExpression ECOMP0in(y=gENROU.v_0) annotation
    ...
    connect(gENROU.PMECH, gENROU.PMECH0) annotation(
        Line(points={{-68.6,7.8},{-76,7.8},{-76,20},{-36,20},{-36,6.5},{-38.7,
              6.5}},                                                                  color = {0, 0, 127}));
      connect(sCRXwInitAsInput.EFD, gENROU.EFD) annotation (Line(points={{-79,
              -8},{-74,-7.8},{-68.6,-7.8}}, color={0,0,127}));
      connect(gENROU.ETERM, sCRXwInitAsInput.ECOMP) annotation (Line(points={{
              -38.7,-3.9},{-32,-3.9},{-32,-40},{-110,-40},{-110,-8},{-98,-8}},
            color={0,0,127}));
      connect(sCRXwInitAsInput.EFD0, gENROU.EFD0) annotation (Line(points={{-94,
              -20},{-94,-36},{-34,-36},{-34,-6.5},{-38.7,-6.5}}, color={0,0,127}));
      connect(sCRXwInitAsInput.ECOMP0, ECOMP0in.y) annotation (Line(points={{
              -86,-20},{-86,-24},{-81,-24}}, color={0,0,127}));
    end TestWithOpenIPSLInitAsInput;

    model TestWithOpenIPSLOriginalSCRX
      extends OpenIPSL.Tests.Controls.PSSE.ES.SCRX(pwFault(t1=12, t2=12.15));
